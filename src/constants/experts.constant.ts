...
export const EXPERTS: IExpert[] = [
  {
    ...
    functional_description_ar:
      'أخصائية أمراض النساء والتوليد، حاصلة على البورد الأردني في طب النسائية والتوليد، وهي عضو في الجمعية الأردنية لأمراض النسائية والولادة',
    functional_description_en:
      'Obstetrician and Gynecologist, holds the Jordanian Board in Obstetrics and Gynecology, and is a member of the Jordanian Society of Obstetrics and Gynecology. ',
  ...
  },
  {
    ...
    functional_description_ar:
      'طبيب أردني أخصائي نسائية وتوليد أنهى دراسة الطب الأولى من الأردن ثم تابع دراسته في الولايات المتحدة الأمريكية، يحمل شهادة البورد',
    functional_description_en:
      'A Jordanian doctor, a specialist in obstetrics and gynecology, who completed his medical studies in Jordan, then continued his studies in the United States of America. He holds a board certificate',
  ...
  },
  {
    ...
    functional_description_ar:
      'سيرسا قورشة أخصائية طفولة وإرشاد والدي. لدى سيرسا أكثر من 10-سنوات خبرة في العمل المباشر مع الأسر والأطفال وبالتحديد في ما يتعلق...',
    functional_description_en:
      'Sirsa Qursha is a Child and Parenting Specialist. Sirsa has over 10 years of experience working directly with families and children, specifically in relation to...',
  ...
  },
  {
    ...
    functional_description_ar:
      'د.ليندا هي طبيبة أطفال متخصصة معتمدة، وهي حاصلة على البورد في الأمراض المعدية لدى الأطفال والطب التكاملي والشامل',
    functional_description_en:
      'Dr. Linda is a board-certified pediatrician, board-certified in pediatric infectious diseases and integrative and holistic medicine. ',
  ...
  return EXPERTS.map((expert: IExpert) => {
    return {
      ...
      functional_description:
        lang === 'ar' ? expert.functional_description_ar : expert.functional_description_en,
